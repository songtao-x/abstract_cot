...
#SBATCH --output=/home/songtaow/projects/aip-qchen/songtaow/reward_hack/abstract/train/log/cd_grpo_norm/%j.out
#SBATCH --error=/home/songtaow/projects/aip-qchen/songtaow/reward_hack/abstract/train/log/cd_grpo_norm/%j.err

#SBATCH --job-name=grpo_norm
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
#SBATCH --mem=300G
...
output_dir="$project_root/outputs/grpo_abstract_norm"
num_processes=4
...
mkdir -p "$project_root/log/cd_grpo_norm"
...
echo "[run_grpo] mode=per-token normalization (no contrastive)"
...
# Bump NCCL collective timeout (default 600s) so a slow inner op (e.g. ZeRO-3
# all-gather during contrastive generate or attn scoring) doesn't crash the run.
