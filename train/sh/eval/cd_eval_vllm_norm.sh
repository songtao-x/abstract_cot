...
#SBATCH --output=/home/songtaow/projects/aip-qchen/songtaow/reward_hack/abstract/train/log/cd_eval_vllm_norm/%j.out
#SBATCH --error=/home/songtaow/projects/aip-qchen/songtaow/reward_hack/abstract/train/log/cd_eval_vllm_norm/%j.err

#SBATCH --job-name=cd_eval_vllm_norm
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --mem=120G
...
mkdir -p "$train_root/log/cd_eval_vllm_norm"
