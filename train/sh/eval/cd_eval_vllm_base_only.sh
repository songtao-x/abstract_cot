...
#SBATCH --output=/home/songtaow/projects/aip-qchen/songtaow/reward_hack/abstract/train/log/cd_eval_vllm_base_only/%j.out
#SBATCH --error=/home/songtaow/projects/aip-qchen/songtaow/reward_hack/abstract/train/log/cd_eval_vllm_base_only/%j.err

#SBATCH --job-name=cd_eval_vllm_base_only
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --mem=120G
...
run_name=grpo_abstract_base_only
...
mkdir -p "$train_root/log/cd_eval_vllm_base_only"
